    ...
    return (function () {
        function o(o) {
            ...
            var progress = o.progress,
                progressDuration = o.progressDuration;

            // Assign options to instance properties
        ...
        return (
            ...
            (o.prototype.setContent = function () {
                ...
                if (this.progress) {
                    ...
                    progressWrapper.classList.add("notify-progress");
                    var progressBar = document.createElement("div");
                    progressBar.classList.add("notify-progress-bar");
                    progressBar.style.animationDuration = this.autotimeout + "ms";
                    progressWrapper.appendChild(progressBar);
                    t.appendChild(progressWrapper);
                }
