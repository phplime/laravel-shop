...
return [
    ...
    */
    ...
    |
    */
    'layout' => env('TYRO_LOGIN_LAYOUT', 'split-left'),
    ...
    */
    'social' => [
        ...
        'providers' => [
            'google' => [
                'enabled' => env('TYRO_LOGIN_SOCIAL_GOOGLE', true),
                'label' => 'Google',
                'icon' => 'google', // Icon identifier for the button
            ],
            'facebook' => [
                'enabled' => env('TYRO_LOGIN_SOCIAL_FACEBOOK', true),
                'label' => 'Facebook',
                'icon' => 'facebook',
            ],
            'github' => [
                'enabled' => env('TYRO_LOGIN_SOCIAL_GITHUB', true),
                'label' => 'GitHub',
                'icon' => 'github',
            ],
            'twitter' => [
                'enabled' => env('TYRO_LOGIN_SOCIAL_TWITTER', true),
                'label' => 'X',
                'icon' => 'twitter',
            ],
            'linkedin' => [
