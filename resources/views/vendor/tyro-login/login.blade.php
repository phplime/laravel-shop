        ...
        <div class="form-card">
            ...
            <form method="POST" action="{{ route('tyro-login.login.submit') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="login" name="both" class="form-input @error('login') is-invalid @enderror" value="{{ old('login') }}" autocomplete="username" autofocus placeholder="Email or username">
                    @error('login')
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="password" name="password" class="form-input @error('password') is-invalid @enderror" autocomplete="current-password" placeholder="Password">
                    @error('password')
                    <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
