<x-profile-layout>
    ...
    <div class="container w-full h-full flex align-center">
        <div class="topSlider_wrap">
            <div class="hero-bannerWrap"
                style="background-image: url('{{ asset('assets/frontend/images/hero-banner1.jpg') }}')">
            </div>
            <div class="hero-bannerWrap"
                style="background-image: url('{{ asset('assets/frontend/images/hero-banner2.jpg') }}')">
            </div>
            <div class="hero-bannerWrap"
                style="background-image: url('{{ asset('assets/frontend/images/hero-banner3.jpg') }}')">
            </div>
        </div>
    </div>
    </section>
                    ...
                    <div class="masonry-item itemView" data-id="1">
                        <div class="card">
                            ...
                            <div class="itemDetails">
                                ...
                                <p class="itemInfo">This is a longer card with supporting text below as a natural
                                    lead-in
