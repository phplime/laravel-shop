<form action="<?= base_url("admin/settings/add_settings") ?>" onsubmit="formSubmit(event,this)" method="post">
    <div class="row">
                    ...
                    <div class="card-content">
                            ...
                            <div class="form-group col-md-12 mb-2rm">
                                ...
                                <div class="mt-10 flex gap-20 flex-wrap">
                                    <?php foreach ($language_list as  $key => $lang) : ?>
                                        <label class="custom-radio"> <input type="radio" name="language" value="<?= $lang->slug; ?>" <?= __settings('language') == $lang->slug ? "checked" : "" ?>> <?= $lang->language_name; ?></label>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="ci-input-group input-group-append">
                                    <div class="input-group">
                                        <span>
                                            <span class="fi fi-<?= country(__settings('country_id'))->code ?>"></span>
                                        </span>
                                    </div>
                                    <input type="text" name="dial_code" class="form-control" value="<?= __settings('dial_code') ?? ''; ?>">
                                </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="app_name" class="form-control" value="<?= __settings('app_name') ?? ''; ?>">
                                <!-- /# -->
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="menu_style" id="menu_style" class="form-control">
                                    <option value="0" <?= __settings('menu_style') == 0 ? "selected" : ""; ?>><?= lang('sidebar'); ?></option>
                                    <option value="1" <?= __settings('menu_style') == 1 ? "selected" : ""; ?>><?= lang('top_menu'); ?></option>
                                </select>
                                <!-- /# -->
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select name="currency_position" id="currency_position" class="form-control niceSelect">
                                <option value="left" <?= __settings('currency_position') == "left" ? "checked" : ''; ?>>$100</option>
                                <option value="right" <?= __settings('currency_position') == "right" ? "checked" : ''; ?>>100$</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="number_format" id="number_format" class="form-control niceSelect">
                                <option value="0" <?= __settings('number_format') == "0" ? "checked" : ''; ?>>100</option>
                                <option value="1" <?= __settings('number_format') == "1" ? "checked" : ''; ?>>100.00</option>
                                <option value="2" <?= __settings('number_format') == "1" ? "checked" : ''; ?>>1.00,00</option>
                                <option value="3" <?= __settings('number_format') == "1" ? "checked" : ''; ?>>1,00.00</option>
                            </select>
                        </div>
                    </div><!-- row -->
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section">
                                <div class="section-header">
                                    <h4><?= lang('Subscription_invoice'); ?></h4>
                                </div>
                                <div class="section-body">
                                    <div class="form-group">
                                        <label><?= __('tax'); ?> <small><?= __('tax_percent_for_invoice'); ?></small></label>

                                        <div class="ci-input-group input-group-prepand">

                                            <input type="text" name="tax_percent" class="form-control only_number" value="<?= __settings('tax_percent') ?? ''; ?>">
                                            <div class="input-group">
                                                <span>
                                                    %
                                                </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tax_number" class="form-control" value="<?= __settings('tax_number') ?? ''; ?>">
                                    </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="color_picker">
                                                <label class="ci-input-group input-group-prepand">
                                                    <input type="color" class="form-control" name="color" value="<?= '#' . __settings('color') ?? '#06bc76' ?>" autocomplete="off">
                                                    <div class="input-group ci-color">
                                                        <span style="background: <?= '#' . __settings('color') ?? '#06bc76' ?>"> <i class="fas fa-eye-dropper"></i> </span>
                                                    </div>
                                                </label>
                                            </div>
                                        </div>
