...
<div class="col-lg-3 sidebarStyle">
    ...
    $menu_items = [
        ...
        ['title' => __('email_settings'), 'url' => 'vendor/settings/email-settings', 'icon' => 'icofont-envelope', '_title' => 'Email Settings', 'page_title' => $page_title ?? ''],

        ['title' => __('apperence'), 'url' => 'vendor/settings/apperence', 'icon' => 'fas fa-paint-brush', '_title' => 'Apperence', 'page_title' => $page_title ?? ''],

        ['title' => __('available_days'), 'url' => 'vendor/settings/available-days', 'icon' => 'fas fa-calendar-check', '_title' => 'Available Days', 'page_title' => $page_title ?? ''],

        ['title' => __('payment_settings'), 'url' => 'vendor/settings/payment-settings', 'icon' => 'fas fa-credit-card', '_title' => 'Payment Settings', 'page_title' => $page_title ?? ''],

        ['title' => __('slider'), 'url' => 'vendor/settings/slider', 'icon' => 'fas fa-sliders-h', '_title' => 'Slider', 'page_title' => $page_title ?? ''],

        ['title' => __('qrcode'), 'url' => 'vendor/settings/qrcode', 'icon' => 'fas fa-qrcode', '_title' => 'QR code', 'page_title' => $page_title ?? '']
    ];
