        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <div class="">
                        <input type="text" name="stripe_public_key" placeholder="<?= !empty(lang('public_key')) ? lang('public_key') : "Stripe Public key"; ?>" class="form-control" value="<?= !empty($config->stripe_public_key) ? ($config->stripe_public_key) : '';  ?>">
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <div class="">
                        <input type="text" name="stripe_secret_key" placeholder="<?= !empty(lang('secret_key')) ? lang('secret_key') : "Stripe Secret key"; ?>" class="form-control" value="<?= !empty($config->stripe_secret_key) ? ($config->stripe_secret_key) : '';  ?>">
                    </div>
                </div>
            </div>
        </div>
