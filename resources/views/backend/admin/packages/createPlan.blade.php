    ...
    <div class="row">
        <div class="col-lg-9">
            <div class="card">
                ...
                <form method="POST" action="{{ url('admin/package/savePackage') }}" onsubmit="formSubmit(event,this);">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                    ...
                    <div class="card-footer text-right">
                        <?= hidden('id', $row->id ?? 0) ?>
                        <a href="<?= url('admin/package/package_list') ?>" class="btn btn-default float-left"><?= __('cancel') ?></a>
                        <?= submitBtn() ?>
                    </div>
                </form>
            </div>
