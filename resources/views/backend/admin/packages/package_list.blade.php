        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <?= __addBtn(url('admin/package/create-package')) ?>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                <tr id="hide_1">
                                    ...
                                    <td data-label="<?= __('price') ?>">
                                        {{ admin_currency_position($row['price']) }}
                                        @if (!empty($row['previous_price']))
                                        <span class="previous_price text-nowrap">{{ admin_currency_position($row['previous_price']) }}</span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="btnGroup" data-label="<?= __('action') ?>">
                                        <?= __editBtn(url('admin/package/edit-package/' . $row['slug'])) ?>
