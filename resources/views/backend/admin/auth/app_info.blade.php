    ...
    <div class="col-md-8">
        <div class="card">
            <div class="cardHeader p-15">
                ...
                <small>Enable <?= env("CI_ENV") == 'development' ? 'Production' : "Development"; ?> Mode</small>
            </div>
            <div class="card-body">
            ...
            <div class="card-footer text-right ">
                <?php if (env("CI_ENV") == 'development') : ?>
                    <a href="<?= base_url("admin/auth/setEnvironment/production") ?>" class="btn btn-secondary btn-block action_btn"><?= lang('disabled'); ?></a>
                <?php else : ?>
                    <a href="<?= base_url("admin/auth/setEnvironment/development") ?>" class="btn btn-danger btn-block action_btn"><?= lang('enable'); ?></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center border-bottom  single_app_info">
                    ...
                    <p class="d-flex flex-column text-right">
                        <span class="badge bg-primary-soft text-md badge-pill"><?= site_settings('version'); ?></span>
                    </p>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center border-bottom  single_app_info">
                    ...
                    <p class="d-flex flex-column text-right fz-16">
                        <a target="_blank" href="https://phplime-envato.gitbook.io/xshop/"> <?= __settings('app_name'); ?>
                ...
                <?php if (is_demo() == 0) : ?>
                    <?php if (!auth('is_staff')) : ?>
                        <div class="d-flex justify-content-between align-items-center border-bottom  single_app_info">
                            ...
                            <p class="d-flex flex-column text-right">
                                <span class="label label-default fz-16"><?= site_settings('purchase_code'); ?></span>
                            </p>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
