...
<div class="row">
    ...
    <div class="{{ __settings('menu_style') == 1 ? 'col-lg-8' : 'col-lg-5' }} col-xs-12">
        ...
        @php echo __startForm(url('admin/settings/add_email_settings'), 'post'); @endphp
        @csrf
        @php $smtp = isJson(__settings('smtp_config')) ? json_decode(__settings('smtp_config')) : ''; @endphp
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="card-content">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="">
                                    <select name="mail_type" class="form-control email_option">
                                        <option value="smtp" <?= __settings('mail_type') == 'smtp' ? 'selected' : '' ?>>
                                            <?= lang('smtp'); ?></option>
                                        <option value="sendgrid" <?= __settings('mail_type') == 'sendgrid' ? 'selected' : '' ?>>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="">
                                <input type="text" name="no_reply" placeholder="do-not-reply@xxx.com"
                                    class="form-control"
                                    value="{{ isset($smtp->no_reply) && !empty($smtp->no_reply) ? $smtp->no_reply : '' }}"
                                    autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="smtp emailTypes <?= __settings('mail_type') == 'smtp' || __settings('mail_type') == '' ? '' : 'dis-none' ?>">
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="">
                                    <input type="text" name="smtp_host" placeholder="<?= lang('smtp_host'); ?>"
                                        class="form-control"
                                        value="{{ isset($smtp->smtp_host) && !empty($smtp->smtp_host) ? $smtp->smtp_host : '' }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <div class="">
                                    <input type="text" name="smtp_port" placeholder="<?= lang('smtp_port'); ?>"
                                        class="form-control"
                                        value="{{ isset($smtp->smtp_port) && !empty($smtp->smtp_port) ? $smtp->smtp_port : '' }}"
                                        autocomplete="off">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="emailTypes sendgrid <?= __settings('mail_type') == 'sendgrid' ? '' : 'dis-none ' ?>">
                        <div class="row ">
                            <div class="col-md-12 ">
                                <div class="form-group col-md-12">
                                    <label><?= lang('sendgrid_api_key'); ?></label>
                                    <input type="text" name="sendgrid_api_key" class="form-control"
                                        value="{{ isset($smtp->sendgrid_api_key) && !empty($smtp->sendgrid_api_key) ? $smtp->sendgrid_api_key : '' }}"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group col-md-12 mt-20">
                                ...
                                <div class="">
                                    <a href="<?= url('admin/settings/testmail'); ?>" target="_blank"
    ...
    <div class="<?= __settings('menu_style') == 1 ? "col-lg-4" : "col-lg-4"; ?>">
        <?php if (__settings('is_email_verify') == 1 || __settings('is_sendgrid') == 1): ?>
            <form action="<?= url("admin/settings/add_email_template") ?>" onsubmit="formSubmit(event,this)" method="post">
                @csrf
                @php $emailType = \App\Data\EmailTemplates::mailType(); @endphp
                @php $getMsg = !empty(__settings('email_template_config')) && isJson(__settings('email_template_config')) ? json_decode(__settings('email_template_config'), true) : ''; @endphp

                @php $lang = __site_language(); @endphp
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @foreach ($emailType as $keys => $values)
                    ...
                    <div class="card-footer text-right">
                        ...
                        <button class="btn btn-secondary" type="submit"><?= lang('submit'); ?> <i class="icofont-hand-drag1"></i></button>
                    </div>
                </div>
            </form>
        <?php else: ?>
