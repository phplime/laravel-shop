<nav class="main-header navbar navbar-expand navbar-white navbar-light ">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item hidden">
            <a href="{{ url('DashboardController/index') }}" class="nav-link">Dashboard</a>
        </li>
        <a href="#" class="nav-link"><span class="fi fi-bd"></span> 0.6069</a>
    </ul>
    <!-- Right navbar links -->
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <a href="" class="dropdown-item">
                    <i class="fi fi-us fz-14"></i> English
                </a>
            </div>
        </li>
        ...
        <li class="nav-item dropdown hidden">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="{{ asset('assets/backend/images/avatar.png') }}" alt="User Avatar"
        ...
        <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
                ...
                <div class="text-center">
                    <small>Login - 01 Nov, 2025 - 11:35 am</small>
                </div>
                <!-- Menu Body -->
                <!-- Menu Footer-->
