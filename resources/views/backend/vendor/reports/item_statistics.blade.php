            ...
            <div class="card">
                <div class="card-body">
                    <div class="search-area">
                        <input type="text" class="search-input form-control" placeholder="Search items by name or ID..."
                            id="searchInput">
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="chart-bars blue-bars" id="itemsChart">
                        <div class="bar" title="Chicken Noodle Soup: 1" style="height: 100%;"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    <h2 class="metric-value count" id="totalRevenue">$10.00</h2>
                    <div class="chart-bars green-bars" id="revenueChart">
                        <div class="bar" title="Chicken Noodle Soup: 20" style="height: 100%;"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="chart-bars purple-bars" id="quantityChart">
                        <div class="bar" title="Chicken Noodle Soup: 1" style="height: 100%;"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="chart-bars orange-bars" id="avgPriceChart">
                        <div class="bar" title="Chicken Noodle Soup: $20.00" style="height: 100%;"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h1 class="product-name mb-1rm" id="topQtyName">Chicken Noodle Soup</h1>
                    <div class="product-details" id="topQtyDetails"><span class="dcolor"><b>1</b></span> Units (20.00 $
                        Revenue)</div>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h1 class="product-name mb-1rm" id="topRevenueName">Chicken Noodle Soup</h1>
                    <div class="product-details" id="topRevenueDetails"><span class="dcolor"><b>20.00 $</b></span> Earned (1
                        Units)</div>
                        ...
                        <table class="table" id="orderTable">
                            ...
                            <tbody id="tableBody">
                                <tr>
                                    ...
                                    <td class="item-name">Chicken Noodle Soup</td>
                                    <td>1</td>
                                    <td>20.00 $</td>
