        ...
        <div class="card-body">
            <div class="filterArea d-flex align-center gap-10">
                <div class="form-group">
                    ...
                    <input type="text" name="daterange" class="form-control datetime" placeholder="<?= __('date') ?>"
                        value="">
                </div>
                <div class="form-group">
                    <label for=""></label>
            ...
            <div class="card">
                <div class="card-body">
                    <ul class="menuUl orderTypeMenu gap-10">
                        <li class="orderType active" data-type=""><a href="javascript:;">All </a></li>
                        <li class="orderType" data-type="dinein"><a href="javascript:;">Dine-in <span
                                    class="badge badge-primary ml-5 d-none">4</span></a></li>
                        <li class="orderType" data-type="cod"><a href="javascript:;">Cash on delivery <span
                                    class="badge badge-primary ml-5 d-none">4</span></a></li>
                        <li class="orderType" data-type="paycash"><a href="javascript:;">Pay cash <span
                                    class="badge badge-primary ml-5 d-none">3</span></a></li>
                        <li class="orderType" data-type="pickup"><a href="javascript:;">Pickup / takeaway <span
                                    class="badge badge-primary ml-5 d-none">2</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
