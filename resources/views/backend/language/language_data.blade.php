                    ...
                    <form action="{{ url('add/language_data') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mt-12">
                                <div class="">
                                    <button type="submit" class="btn-primary custom_btn btn mt-20"><i class="icofont-hand-drag1"></i> <?= lang('submit') ?></button>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-body">
                    ...
                    <div class="langauageFilter space-between flex-row align-center gap-1rm mb-2rm">
                        ...
                        <select name="limit" class="form-control wd-5rm " id=""
                            ...
                            <option value="" <?= isset($_GET['limit']) && $_GET['limit'] == 30 ? 'selected' : '' ?>>30</option>
                            <option value="" <?= isset($_GET['limit']) && $_GET['limit'] == 50 ? 'selected' : '' ?>>50</option>
                            <option value="" <?= isset($_GET['limit']) && $_GET['limit'] == 100 ? 'selected' : '' ?>>100</option>
                            <option value="" <?= isset($_GET['limit']) && $_GET['limit'] == 200 ? 'selected' : '' ?>>200</option>
                            <option value="" <?= isset($_GET['limit']) && $_GET['limit'] == 300 ? 'selected' : '' ?>>300</option>
                            <option value="" <?= isset($_GET['limit']) && $_GET['limit'] == 500 ? 'selected' : '' ?>>500</option>
                        </select>
                            ...
                            <div class="row flex justify-content-end">
                                <div class="text-right col-md-12">
                                    ...
                                    <div class="exportDataArea mt-1rm  mb-1rm">
                                        <a href="#lnModal_en" data-toggle="modal"
                                            class="btn btn-success btn-sm"><i class="icofont-upload"></i>
                                            <?= lang('import') ?> </a>
                                        <a href="" class="btn btn-secondary btn-sm"> <i class="icofont-download"></i>
                                            <?= lang('export') ?></a>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="hide_details">
                                                    <input type="text" name="details[]" class="form-control" value="Add New">
                                                    </td>
                                                <td>
                                                    <input type="text" name="en[]"  class="form-control" value="Add New">
                                                </td>
                                            </tr>
