...
<div class="form-group">
    ...
    <input type="text" name="slug" class="form-control" placeholder="Language Slug" <?= isset($data['slug']) && !empty($data['slug']) ? "readonly" : ''; ?> value="">
</div>
<div class="form-group">
    ...
    <div class="">
        <select name="direction" id="direction" class="form-control">
            <option value="ltr" <?= isset($data['direction']) && $data['direction'] == "ltr" ? "selected" : ''; ?>>
                <?= !empty(lang('ltr')) ? lang('ltr') : "LTR"; ?> (<?= !empty(lang('left_to_right')) ? lang('left_to_right') : "Left to right"; ?>)
            </option>
            <option value="rtl" <?= isset($data['direction']) && $data['direction'] == "rtl" ? "selected" : ''; ?>>
                <?= !empty(lang('rtl')) ? lang('rtl') : "RTL"; ?> (<?= !empty(lang('right_to_left')) ? lang('right_to_left') : "Right to left"; ?>)
            </option>
        </select>
    </div>
</div>
